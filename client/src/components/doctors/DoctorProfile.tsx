...
const DoctorProfile: React.FC<DoctorProfileProps> = ({isVisible, updateVisibility, doctorData}) => {

  return (
    <>
    {isVisible && <div className='z-50 absolute top-0 left-0 w-full min-h-full flex justify-center items-center text-[#161616]'>
        <div className="shadow-2xl relative px-3 py-8 w-[95%] h-[75%] bg-white border border-[#f7f7f7] rounded-[15px]">
                  ...
                  <div className="w-full min-h-full flex flex-col space-y-[1rem]">
                        ...
                        <div className='w-full flex justify-end items-end space-x-4'>
                              ...
                              <button onClick={()=> updateVisibility(false)} className="transition-properties w-[130px] h-[40px] bg-black text-white border border-black text-[14px] rounded-md flex items-center justify-center space-x-2 hover:border-[#121212] hover:bg-[#121212]">
                                    <FaChevronDown className ='text-white text-[14px]'/>
                                    <p>Close</p>
                              </button>

                          
                              <button className="transition-properties w-[130px] h-[40px] text-white border bg-yellow-500 text-[14px] border-yellow-500 rounded-md flex items-center justify-center space-x-2 hover:border-yellow-400 hover:bg-yellow-400">
                                    <MdEditSquare className = "text-white text-[14px]"/>
                                    <p>Edit Profile</p>
                              </button>

                              <button className="transition-properties w-[130px] h-[40px] bg-[#d42c31] text-white border border-[#d42c31] text-[14px] rounded-md flex items-center justify-center space-x-2 hover:border-[#c63439] hover:bg-[#c63439]">
